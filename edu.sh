...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/rajakapur/onesc/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/rajakapur/onesc/main/edu-op.py
